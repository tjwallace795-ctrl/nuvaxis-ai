    ...
    <div className={`min-h-screen w-full overflow-x-hidden relative ${className || ''}`}>
      ...
      >
        <div
          ...
          className="relative left-[calc(50%+3rem)] aspect-[1155/678] w-[36.125rem] max-w-none -translate-x-1/2 opacity-25 sm:left-[calc(50%+36rem)] sm:w-[72.1875rem] min-h-screen"
        />
      </div>
      ...
      {showHeader && (
        <header className="absolute inset-x-0 top-0 z-10">
          ...
          <Dialog open={mobileMenuOpen} onOpenChange={setMobileMenuOpen}>
            <DialogContent className="fixed inset-y-0 right-0 z-50 w-full overflow-y-auto bg-[#0d0620] px-4 py-4 sm:px-6 sm:py-6 sm:max-w-sm sm:ring-1 sm:ring-white/10 lg:hidden">
